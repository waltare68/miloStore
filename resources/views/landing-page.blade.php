    ...
    <body>
        <div id="app">
            <header class="with-background">
                <div class="top-nav container">
                    <div class="top-nav-left">
                        <div class="logo">MiloEcommerce</div>
                ...
                <div class="hero container">
                    <div class="hero-copy">
                        <h1>Milo Online Store</h1>
                        <p>Includes multiple products, categories, a shopping cart and a checkout system </p>
                        <div class="hero-buttons">
                            <a href="https://www.youtube.com/playlist?list=PLEhEHUEU3x5oPTli631ZX9cxl6cU_sDaR" class="button button-white">LInkedIn</a>
                            <a href="https://github.com/waltare68" class="button button-white">GitHub</a>
                        </div>
                    </div> <!-- end hero-copy -->
            ...
            <div class="featured-section">
                ...
                <div class="container">
                    <h1 class="text-center">Milo Online Store</h1>
